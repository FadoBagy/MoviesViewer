        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayedInMoviesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorMovie", x => new { x.ActorsId, x.PlayedInMoviesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorMovie_Movies_PlayedInMoviesId",
                        column: x => x.PlayedInMoviesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WrittenMoviesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieWriter", x => new { x.WritersId, x.WrittenMoviesId });
                    table.ForeignKey(
                        name: "FK_MovieWriter_Movies_WrittenMoviesId",
                        column: x => x.WrittenMoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorMovie_PlayedInMoviesId",
                table: "ActorMovie",
                column: "PlayedInMoviesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieWriter_WrittenMoviesId",
                table: "MovieWriter",
                column: "WrittenMoviesId");
